    ...
    <MDBFooter style={{ backgroundColor: "#2b2c2e" }} className="text-white">
      <MDBContainer className="p-4">
        <MDBRow>
          ...
          <MDBCol lg="3" md="5" sm="5" className="mb-4 mb-md-0">
            ...
            <ul className="list-unstyled mb-1">
              ...
              <li>
                <HashLink to="/about#about" className="text-decoration-none text-white">
                  Conócenos
                </HashLink>
              </li>
              <li>
                <HashLink to="/faq#faq" className="text-decoration-none text-white">
          ...
          <MDBCol lg="3" md="5" sm="5" className="mb-4 mb-md-0">
            ...
            <ul className="list-unstyled mb-1">
              ...
              <li>
                <HashLink to="/home#contacto" className="text-decoration-none text-white">
                  Contáctanos
                </HashLink>
              </li>
            </ul>
